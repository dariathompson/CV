...
| [Puppy Pals](https://github.com/dariathompson/puppy-pals) | App that allows dogs to find new play dates | React, Node, Redux, MongoDB, Express |
...
* Applied time management skills to ensure orders from clients are recorded accurately and received on time.
* Used teamwork and communication skills as well as empathy to respond to client complaints, ensuring prompt resolution of issues to avoid escalation.
